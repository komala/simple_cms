...
ActiveRecord::Schema.define(version: 20161125121025) do

  create_table "admin_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "first name",      limit: 40
  ...
  create_table "bages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.index ["permalink"], name: "index_bages_on_permalink", using: :btree
    t.index ["subject_id"], name: "index_bages_on_subject_id", using: :btree
  end
